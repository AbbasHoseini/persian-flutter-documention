...
***چون من از این منابع به فلاتر نیومدم از ترجمه ی این بخش میگذرم و اگر خواستید و نیازتون شد، میتونید از این (https://docs.flutter.dev/development/data-and-backend/state-mgmt/options)[لینک] خودتون مطالعه کنید.***
